...
import { GraduationCap, Eye, EyeOff, Users, BookOpen, Mail } from "lucide-react";
            ...
            <>
              ...
              <div>
                ...
                <Input
                  id="gradeSection"
                  type="text"
                  placeholder="e.g., Grade 10 - Lopez Jaena"
          ...
          {formData.userType === "parent" && (
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <Label htmlFor="parentPhone" className="text-[#0F2854]">
                    Phone Number *
                  </Label>
                  <Input
                    id="parentPhone"
